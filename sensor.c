...
void initsensor (osjobcb_t callback) {
    ...
    //hw_cfg_extirq(INP_PORT, INP_PIN, GPIO_IRQ_CHANGE); //for both rising and falling edge
		hw_cfg_extirq(INP_PORT, INP_PIN, GPIO_IRQ_RISING ); //for only rising edges 2015-05-25 Modified by Carlos
